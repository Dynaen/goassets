...
function makeWidget() {
  ...
  original.remove();
  const header = "Check Backlinks for Any URL";
  const sub =
    "Analyze competitors' backlinks to find new link-building opportunities";
  const footer = "Free Backlink Checker Tool";
...
function initsearch(e) {
  ...
  const fullUrl = `https://www.semrush.com/signup/?onboarding=off&src=blog&redirect_to=%2Fanalytics%2Fbacklinks%2Foverview%2F%3Fq%3D${searchParameter}`;
