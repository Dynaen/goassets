var translations = {
  ["en-us"]: {
    ...
    tab1Img:
      "https://cdn.jsdelivr.net/gh/dynaen/goassets/GP/GP197/1_US_large.png",
    tab1ImgSmall:
      "https://cdn.jsdelivr.net/gh/dynaen/goassets/GP/GP197/1_US_small.png",
    ...
    tab2Img:
      "https://cdn.jsdelivr.net/gh/dynaen/goassets/GP/GP197/2_US_large.png",
    tab2ImgSmall:
      "https://cdn.jsdelivr.net/gh/dynaen/goassets/GP/GP197/2_US_small.png",
    ...
    tab3Img:
      "https://cdn.jsdelivr.net/gh/dynaen/goassets/GP/GP197/3_US_large.png",
    tab3ImgSmall:
      "https://cdn.jsdelivr.net/gh/dynaen/goassets/GP/GP197/3_US_small.png",
    ...
    tab4Img:
      "https://cdn.jsdelivr.net/gh/dynaen/goassets/GP/GP197/4_US_large.png",
    tab4ImgSmall:
      "https://cdn.jsdelivr.net/gh/dynaen/goassets/GP/GP197/4_US_small.png",
  },
  ["pt-br"]: {
    ...
    tab1Img:
      "https://cdn.jsdelivr.net/gh/dynaen/goassets/GP/GP197/1_BR_large.png",
    tab1ImgSmall:
      "https://cdn.jsdelivr.net/gh/dynaen/goassets/GP/GP197/1_BR_small.png",
    ...
    tab2Img:
      "https://cdn.jsdelivr.net/gh/dynaen/goassets/GP/GP197/2_BR_large.png",
    tab2ImgSmall:
      "https://cdn.jsdelivr.net/gh/dynaen/goassets/GP/GP197/2_BR_small.png",
    tab3Header: "Nutrição",
    tab3Copy:
      "Nossa saúde física e mental dependem muito do que comemos. Com acesso a apps premium, os assinantes Gympasss têm orientação nutricional, receitas saudáveis, listas de compras e muito mais!",
    tab3Img:
      "https://cdn.jsdelivr.net/gh/dynaen/goassets/GP/GP197/3_BR_large.png",
    tab3ImgSmall:
      "https://cdn.jsdelivr.net/gh/dynaen/goassets/GP/GP197/3_BR_small.png",
    ...
    tab4Img:
      "https://cdn.jsdelivr.net/gh/dynaen/goassets/GP/GP197/4_BR_large.png",
    tab4ImgSmall:
      "https://cdn.jsdelivr.net/gh/dynaen/goassets/GP/GP197/4_BR_small.png",
  },
};
...
function runobs() {
  ...
  var observer = new MutationObserver(function () {
    const container = document.querySelector(
      "section[data-experimentation='hero_section'] + section"
    );
...
function setIndicator() {
  ...
  if (indicator && tab) {
    ...
    indicator.style.top = tab.offsetTop + tab.offsetHeight - 4 + "px";
