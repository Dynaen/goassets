...
function createWidget() {
  ...
  widget.innerHTML = `<h6>Page Metrics for November</h6>
    ...
    <a href="https://www.semrush.com/analytics/organic/overview/?db=us&q=${currentURL}&searchType=subfolder" id="keywords" class="sp-col"><p class="sp-numbers">XXX</p><p>keywords<br/>driving traffic</p></a>
    <a href="https://www.semrush.com/analytics/backlinks/overview/?q=${currentURL}&protocol=https&currency=usd" id="backlinks" class="sp-col"><p class="sp-numbers">XXX</p><p>sources linking<br/>to this page</p></a>
    </div>
