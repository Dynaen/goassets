...
function createWidget() {
  ...
  widget.innerHTML = `<h6>Page Metrics for November</h6>
    ...
    <div class="sp-cols">
    <a href="https://www.semrush.com/analytics/overview/?searchType=subfolder&q=${currentURL}" id="traffic" class="sp-col"><p>monthly traffic</p><p class="sp-numbers">XXX</p></a>
    <a href="https://www.semrush.com/analytics/organic/overview/?db=us&q=${currentURL}&searchType=subfolder" id="keywords" class="sp-col"><p>keywords driving traffic</p><p class="sp-numbers">XXX</p></a>
    <a href="https://www.semrush.com/analytics/backlinks/overview/?q=${currentURL}&protocol=https&currency=usd" id="backlinks" class="sp-col"><p>sources linking to this page</p><p class="sp-numbers">XXX</p></a>
    </div>
