...
function createWidget() {
  ...
  widget.id = "sp-widget";
  widget.innerHTML = `<h6>Page Stats for [month]</h6>
    <p class="sp-strapline">Data from Sermrush tools</p>
    <div class="sp-cols">
    <div class="sp-col"><p>Traffic</p><p class="sp-numbers">XXX</p></div>
    <div class="sp-col"><p>Keywords</p><p class="sp-numbers">XXX</p></div>
    <div class="sp-col"><p>Backlinks</p><p class="sp-numbers">XXX</p></div>
    </div>
